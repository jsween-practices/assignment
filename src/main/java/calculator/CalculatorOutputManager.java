...
void printSelectActivity() {
    System.out.println(SELECT_ACTIVITY);
  }

  void printInputFirstNumber() {
    System.out.println(INPUT_FIRST_NUMBER);
  }

  void printInputSecondNumber() {
    System.out.println(INPUT_SECOND_NUMBER);
  }

  void printExpression(int firstNumber, int secondNumber, Command command, int result) {
